  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover kidsbox, your ultimate WordPress solution. Experience an innovative subscription box theme, tailored for a captivating and seamless user journey."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1566207474742-de921626ad0c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3b3JkcHJlc3N8ZW58MHx8fHwxNjk5Nzk4NzEzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@tozakfikret?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Fikret tozak`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover kidsbox, your ultimate WordPress solution. Experience an innovative subscription box theme, tailored for a captivating and seamless user journey.`}
            </Text>
            <Box
